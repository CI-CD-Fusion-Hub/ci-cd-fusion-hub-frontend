  ...
  <div class="tabs-holder">
    <nav>
      <VButtonSet>
        ...
        >
          <VButton
            v-for="tab in $slots[slot]()"
            :key="tab"
            :icon="tab.props.icon"
            :data-id="tab.props.header"
            :is-active="isTabActive(tab.props.header)"
            class="tab-button"
            @on-click="changeTab(tab.props.header)"
          >
    ...
    <div class="tabs">
      ...
      >
        ...
        >
          <slot
            v-if="isTabActive(tab.props.header)"
            :name="tab.props.header"
          />
        </template>
      </template>
    </div>
